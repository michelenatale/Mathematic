...
<p><br>Special DataTypes such as [Int128](https://learn.microsoft.com/de-de/dotnet/api/system.int128/) or [BigInteger](https://learn.microsoft.com/de-de/dotnet/api/system.numerics.biginteger/) are also possible</p>
